...
bool IsGamepadButtonDownSDL(int gamepad, int button) {
    if (!IsGamepadAvailableSDL(gamepad)) return false;
    
    SDL_GameControllerButton sdl_button;
    switch(button) {
        case 0: sdl_button = SDL_CONTROLLER_BUTTON_A; break;
        case 1: sdl_button = SDL_CONTROLLER_BUTTON_B; break;
        case 2: sdl_button = SDL_CONTROLLER_BUTTON_X; break;
        case 3: sdl_button = SDL_CONTROLLER_BUTTON_Y; break;
        case 4: sdl_button = SDL_CONTROLLER_BUTTON_LEFTSHOULDER; break;
        case 5: sdl_button = SDL_CONTROLLER_BUTTON_RIGHTSHOULDER; break;
        case 6: sdl_button = SDL_CONTROLLER_BUTTON_BACK; break;
        case 7: sdl_button = SDL_CONTROLLER_BUTTON_START; break;
        case 8: sdl_button = SDL_CONTROLLER_BUTTON_GUIDE; break;
        case 9: sdl_button = SDL_CONTROLLER_BUTTON_LEFTSTICK; break;
        case 10: sdl_button = SDL_CONTROLLER_BUTTON_RIGHTSTICK; break;
        case 11: sdl_button = SDL_CONTROLLER_BUTTON_DPAD_UP; break;
        case 12: sdl_button = SDL_CONTROLLER_BUTTON_DPAD_DOWN; break;
        case 13: sdl_button = SDL_CONTROLLER_BUTTON_DPAD_LEFT; break;
        case 14: sdl_button = SDL_CONTROLLER_BUTTON_DPAD_RIGHT; break;
...
float GetGamepadAxisSDL(int gamepad, int axis) {
    if (!IsGamepadAvailableSDL(gamepad)) return 0.0f;
    
    SDL_GameControllerAxis sdl_axis;
    switch(axis) {
        case 0: sdl_axis = SDL_CONTROLLER_AXIS_LEFTX; break;
        case 1: sdl_axis = SDL_CONTROLLER_AXIS_LEFTY; break;
        case 2: sdl_axis = SDL_CONTROLLER_AXIS_RIGHTX; break;
        case 3: sdl_axis = SDL_CONTROLLER_AXIS_RIGHTY; break;
        case 4: sdl_axis = SDL_CONTROLLER_AXIS_TRIGGERLEFT; break;
        case 5: sdl_axis = SDL_CONTROLLER_AXIS_TRIGGERRIGHT; break;
        default: return 0.0f;
    }
